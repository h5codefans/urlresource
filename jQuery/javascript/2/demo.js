...
/*
	...
	Base.getId('box').css('color','red').css('backgroundColor','blank').html('pox').click(function(){
	       alert('a');
	}).addClass('a');
	
	Base是一个基础库的核心对象
	Base.getId('box')返回的是一个divElement对象，这个对象是没有css方法的
...
window.onload=function(){
  ...
  $().getTagName('p').css('color','green').html('标记').click(function(){
      alert('a');
